/* Daycells in-app feedback: Feedback sheet → Discord webhook (+ mailto / offline queue). */
window.Feedback = (() => {
  'use strict';
  ...
  function sheetHTML(meta) {
    ...
    return '<div class="overlay" id="ovl"><div class="sheet feedbacksheet"><div class="grab"></div>' +
      '<h2>Feedback</h2>' +
      '<p class="mini" style="margin-top:0">Share a bug, idea, or something that felt confusing. Screenshot optional.</p>' +
